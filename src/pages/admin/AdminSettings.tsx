...
const apiIntegrations = [
  ...
  { id: 'service_request_alerts', name: 'Void / Refund / Reissue Alert Inbox', description: 'Customer void, refund & reissue requests never hit the airline API — they only reach the admin panel and these email addresses. Comma-separated; falls back to all admin users when empty.', fields: [{ key: 'enabled', label: 'Enabled', placeholder: '', type: 'select', options: ['true', 'false'] }, { key: 'emails', label: 'Alert Email(s)', placeholder: 'refund@seventrip.net, support@seventrip.net', type: 'text' }], docs: '', category: 'communication' },
