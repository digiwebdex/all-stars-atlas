...
/* ─── Airport coordinates for distance calculation (700+ airports worldwide) ─── */
const AIRPORT_COORDS: Record<string, [number, number]> = {
  ...
  // ── Sri Lanka ──
  CMB:[7.1801,79.8841],HRI:[6.2844,81.1241],
  // ── Nepal ──
  KTM:[27.6966,85.3591],BWA:[27.5054,83.4163],PKR:[28.2009,83.9821],
  // ── Maldives ──
  MLE:[4.1918,73.5291],GAN:[-0.6934,73.1556],
  // ── Myanmar ──
  RGN:[16.9073,96.1332],MDL:[21.7022,95.978],NYT:[19.6235,96.201],
  // ── Bhutan ──
  PBH:[27.4032,89.4246],
  // ── Middle East ──
  DXB:[25.2528,55.3644],SHJ:[25.3286,55.5172],AUH:[24.4331,54.6511],RKT:[25.6133,55.9389],
  DOH:[25.2609,51.6138],RUH:[24.9576,46.6988],JED:[21.6796,39.1565],DMM:[26.4712,49.7979],
  MED:[24.5534,39.7051],TIF:[21.4833,40.5433],AHB:[18.2404,42.6567],TUU:[28.3654,36.6189],
  MCT:[23.5933,58.2844],SLL:[17.0387,54.0914],BAH:[26.2708,50.6336],
  KWI:[29.2266,47.9689],AMM:[31.7226,35.9932],BEY:[33.8209,35.4884],BGW:[33.2625,44.2346],
  BSR:[30.5491,47.6621],EBL:[36.2376,43.9632],NJF:[31.9897,44.4043],
  TLV:[32.0114,34.8867],THR:[35.6894,51.3114],IFN:[32.7508,51.8613],SYZ:[29.5392,52.5899],
  MHD:[36.2352,59.641],TBZ:[38.1339,46.235],AWZ:[31.3374,48.762],KER:[30.2744,56.9511],
  // ── Southeast Asia ──
  SIN:[1.3502,103.9944],KUL:[2.7456,101.7072],PEN:[5.2972,100.2767],LGK:[6.3297,99.7287],
  KCH:[1.4847,110.3473],BKI:[5.937,116.0515],BKK:[13.6811,100.7472],DMK:[13.9126,100.607],
  HKT:[8.1132,98.3169],CNX:[18.7668,98.9626],USM:[9.5478,100.0622],KBV:[8.0991,98.9862],
  HKG:[22.3089,113.9145],MNL:[14.5086,121.0194],CEB:[10.3075,123.9794],DVO:[7.1255,125.6456],
  SGN:[10.8188,106.652],HAN:[21.2212,105.807],DAD:[16.0439,108.1994],CXR:[11.9982,109.2194],
  PQC:[10.1698,103.9931],CGK:[-6.1256,106.6558],DPS:[-8.7482,115.1672],SUB:[-7.3798,112.787],
  UPG:[-5.0616,119.554],JOG:[-7.7882,110.4317],PNH:[11.5466,104.8441],REP:[13.4107,103.8128],
  VTE:[17.9883,102.5633],LPQ:[19.8973,102.161],
  // ── East Asia ──
  NRT:[35.7647,140.3864],HND:[35.5494,139.7798],KIX:[34.4347,135.244],NGO:[34.8584,136.8124],
  FUK:[33.5859,130.4511],CTS:[42.7752,141.6925],OKA:[26.1958,127.6459],
  ICN:[37.4602,126.4407],GMP:[37.5583,126.7906],PUS:[35.1796,128.9382],CJU:[33.5113,126.493],
  PEK:[40.0799,116.6031],PVG:[31.1443,121.8083],CAN:[23.3924,113.299],CTU:[30.5785,103.9471],
  SZX:[22.6393,113.8107],SHA:[31.1979,121.3363],XIY:[34.4471,108.7516],KMG:[24.9924,102.7432],
  CKG:[29.7192,106.6417],WUH:[30.7838,114.2081],HGH:[30.2295,120.4344],NKG:[31.742,118.862],
  TSN:[39.1244,117.3462],TAO:[36.2661,120.3744],DLC:[38.9657,121.5386],SHE:[41.6398,123.4831],
  HRB:[45.6234,126.25],XMN:[24.544,118.1278],CSX:[28.189,113.22],CGO:[34.5197,113.8408],
  SYX:[18.3029,109.4122],HAK:[19.9349,110.459],FOC:[25.9348,119.6633],
  TPE:[25.0777,121.2322],KHH:[22.5771,120.3501],RMQ:[24.2646,120.6211],
  MFM:[22.1496,113.5916],ULN:[47.843,106.7667],
  // ── Europe ──
  LHR:[51.4706,-0.4619],LGW:[51.1481,-0.1903],STN:[51.885,0.235],LTN:[51.8747,-0.3683],
  MAN:[53.3537,-2.275],EDI:[55.9508,-3.3725],BHX:[52.4539,-1.748],GLA:[55.8642,-4.4331],
  BRS:[51.3827,-2.7191],LBA:[53.8659,-1.6606],BFS:[54.6575,-6.2158],
  ...
  FRA:[50.0333,8.5706],MUC:[48.3538,11.7861],TXL:[52.5597,13.2877],BER:[52.3667,13.5033],
  HAM:[53.6304,9.9882],DUS:[51.2895,6.7668],CGN:[50.8659,7.1427],STR:[48.6899,9.2220],
  HAJ:[52.4611,9.6850],NUE:[49.4987,11.0669],LEJ:[51.4324,12.2416],
  AMS:[52.3086,4.7639],EIN:[51.4501,5.3743],
  MAD:[40.4719,-3.5626],BCN:[41.2971,2.0785],PMI:[39.5517,2.7388],AGP:[36.6749,-4.499],
  ALC:[38.2822,-0.5582],VLC:[39.4893,-0.4816],SVQ:[37.418,-5.8931],IBZ:[38.8729,1.3731],
  ...
  IST:[41.2753,28.7519],SAW:[40.8986,29.3092],AYT:[36.8987,30.8005],ADB:[38.2924,27.157],
  ESB:[40.1281,32.9951],DLM:[36.7131,28.7925],TZX:[41.0627,39.7897],
  ATH:[37.9364,23.9445],SKG:[40.5197,22.9709],HER:[35.3397,25.1803],
  VIE:[48.1103,16.5697],GRZ:[46.9911,15.4396],
  ZRH:[47.4647,8.5492],GVA:[46.238,6.1089],BSL:[47.5896,7.5299],
  LIS:[38.7813,-9.1359],OPO:[41.2481,-8.6814],FAO:[37.0144,-7.9659],
  CPH:[55.618,12.656],BLL:[55.7403,9.1518],
  OSL:[60.1939,11.1004],BGO:[60.2934,5.2181],TRD:[63.4578,10.924],SVG:[58.8767,5.6378],
  ARN:[59.6519,17.9186],GOT:[57.6628,12.2798],
  HEL:[60.3172,24.9633],TMP:[61.4141,23.6044],OUL:[64.93,25.3546],
  DUB:[53.4213,-6.2701],SNN:[52.702,-8.9249],ORK:[51.8413,-8.4911],
  WAW:[52.1657,20.9671],KRK:[50.0777,19.7848],GDN:[54.3776,18.4662],WRO:[51.1027,16.886],
  PRG:[50.1008,14.26],BRN:[46.9141,7.4972],
  BUD:[47.4369,19.2556],OTP:[44.5711,26.085],CLJ:[46.7852,23.6862],
  SOF:[42.6952,23.4114],BEG:[44.8184,20.309],ZAG:[45.7429,16.0688],
  LJU:[46.2237,14.4576],TIA:[41.4147,19.7206],SKP:[41.9616,21.6214],
  RIX:[56.9236,23.9711],VNO:[54.6341,25.2858],TLL:[59.4133,24.8328],
  KIV:[46.9277,28.931],MSQ:[53.8825,28.0307],KEF:[63.985,-22.6056],
  ...
  ORD:[41.9742,-87.9073],MDW:[41.786,-87.7524],
  ...
  YOW:[45.3225,-75.6692],YYC:[51.1139,-114.0203],YEG:[53.3097,-113.5797],
  YHZ:[44.8808,-63.5085],YWG:[49.91,-97.2399],YQB:[46.7911,-71.3934],
  MEX:[19.4363,-99.0721],CUN:[21.0365,-86.877],GDL:[20.5218,-103.3113],
  SJO:[9.9939,-84.2088],PTY:[9.0714,-79.3835],SJU:[18.4394,-66.0018],
  NAS:[25.039,-77.4662],MBJ:[18.5037,-77.9134],KIN:[17.9357,-76.7875],
  ...
  BOG:[4.7016,-74.1469],MDE:[6.1645,-75.4231],CLO:[3.5432,-76.3816],CTG:[10.4424,-75.513],
  EZE:[-34.8222,-58.5358],AEP:[-34.5592,-58.4156],COR:[-31.3236,-64.208],
  SCL:[-33.393,-70.7858],LIM:[-12.0219,-77.1143],CUZ:[-13.5357,-71.9389],
  UIO:[-0.1292,-78.3575],GYE:[-2.1574,-79.8837],
  CCS:[10.6012,-66.9913],MVD:[-34.8384,-56.0308],ASU:[-25.2399,-57.5191],
  VVI:[-17.6448,-63.1354],LPB:[-16.5133,-68.1923],
  // ── Africa ──
  ...
  NBO:[-1.3192,36.9278],MBA:[-4.0348,39.5942],
  ADD:[8.9779,38.7993],DIR:[9.6247,41.8542],
  LOS:[6.5774,3.3212],ABV:[9.0065,7.2632],
  ACC:[5.6052,-0.1668],ABJ:[5.2564,-3.9263],
  DSS:[14.7397,-17.4902],CMN:[33.3675,-7.5898],RAK:[31.6069,-8.0363],
  TUN:[36.851,10.2272],ALG:[36.691,3.2154],
  DAR:[-6.8781,39.2026],ZNZ:[-6.2242,39.2249],
  EBB:[0.0424,32.4435],KGL:[-1.9686,30.1395],
  LUN:[-15.3308,28.4526],HRE:[-17.9318,31.0928],
  MRU:[-20.4302,57.6836],TNR:[-18.7969,47.4788],
  MPM:[-26.0408,32.5727],WDH:[-22.4799,17.4709],
  GBE:[-24.5552,25.9182],LLW:[-13.7894,33.781],
  // ── Oceania ──
  ...
  APW:[-13.8299,-171.9978],PPT:[-17.5537,-149.6115],NOU:[-22.0146,166.2128],
  GUM:[13.4834,144.7961],POM:[-6.0148,147.0222],HIR:[-9.4281,160.0549],
  // ── Central Asia ──
  TAS:[41.2579,69.2813],ALA:[43.352,77.0405],NQZ:[51.0222,71.467],
  FRU:[43.0613,74.4776],DYU:[38.5433,68.825],ASB:[37.9868,58.361],
  // ── Caribbean / Central America ──
  BGI:[13.0746,-59.4925],POS:[10.5953,-61.3372],GEO:[6.4985,-58.2541],
  BZE:[17.5391,-88.3082],TGU:[14.0609,-87.2172],SAP:[15.4526,-87.9236],
  MGA:[12.1415,-86.1682],SAL:[13.4409,-89.0557],GUA:[14.5833,-90.5275],
};
...
function buildFareRows(
  paxPricing: any[] | undefined,
  baseFare: number, taxes: number,
  paxAdults: number, paxChildren: number, paxInfants: number,
  discountPct: number, aitVatPct: number,
  /** For round-trip combined view, pass outbound + return paxPricing arrays */
  paxPricing2?: any[]
  ...
  if (mergedPax && mergedPax.length > 0) {
    ...
    for (const pp of mergedPax) {
      ...
      fareRows.push({
        ...
        aitVat,
        count,
        amount: (ppBase - disc + ppTax + aitVat) * count,
      });
    }
  } else {
...
/* ─── Merge two paxPricing arrays (outbound + return) by summing per type ─── */
function mergePaxPricingArrays(arr1?: any[], arr2?: any[]): any[] | null {
  if (!arr1 || arr1.length === 0) return arr2 && arr2.length > 0 ? arr2 : null;
  if (!arr2 || arr2.length === 0) return arr1;
  // Sum by type
  const map: Record<string, any> = {};
  for (const pp of arr1) {
    const key = pp.type || pp.label || 'ADT';
    map[key] = { ...pp, baseFare: pp.baseFare || 0, taxes: pp.taxes || 0, total: pp.total || 0 };
  }
  for (const pp of arr2) {
    const key = pp.type || pp.label || 'ADT';
    if (map[key]) {
      map[key].baseFare += pp.baseFare || 0;
      map[key].taxes += pp.taxes || 0;
      map[key].total += pp.total || 0;
    } else {
      map[key] = { ...pp, baseFare: pp.baseFare || 0, taxes: pp.taxes || 0, total: pp.total || 0 };
    }
  }
...
const LegMini = ({ flight, label, labelColor }: { flight: any; label: string; labelColor: string }) => {
  ...
  return (
    <div className="flex-1 min-w-0">
      {/* Route label badge */}
      <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-md mb-3 text-[11px] font-bold ${
        isReturn 
          ? "bg-amber-50/80 dark:bg-amber-950/30 text-amber-700 dark:text-amber-300" 
          : "bg-accent/10 dark:bg-accent/20 text-accent"
      }`}>
        <Plane className={`w-3.5 h-3.5 ${isReturn ? "rotate-180" : ""}`} />
        <span>{isReturn ? "RETURN" : "DEPARTURE"}</span>
        <span className={isReturn ? "text-amber-300 dark:text-amber-600 font-normal" : "text-accent/40 font-normal"}>|</span>
        <span>{fromCode} → {toCode}</span>
        <span className={isReturn ? "text-amber-300 dark:text-amber-600 font-normal" : "text-accent/40 font-normal"}>|</span>
        <span className="flight-date">{formatShortDate(flight.departureTime)}</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="text-center shrink-0">
          ...
          {departGmt && <p className="text-[10px] text-muted-foreground leading-tight">{departGmt}</p>}
        </div>
        ...
        <div className="text-center shrink-0">
          ...
          {arriveGmt && <p className="text-[10px] text-muted-foreground leading-tight">{arriveGmt}</p>}
        </div>
      </div>
    </div>
  );
...
function sortRoundTripPairs(pairs: { outbound: any; returnFlight: any }[], sortBy: string) {
  const sorted = [...pairs];
  const pairDur = (p: { outbound: any; returnFlight: any }) => getPairDurationMinutes(p);
  const pairStops = (p: { outbound: any; returnFlight: any }) => (Number(p.outbound?.stops) || 0) + (Number(p.returnFlight?.stops) || 0);
  const pairDepartureTs = (p: { outbound: any; returnFlight: any }) => (p.outbound?.departureTime ? new Date(p.outbound.departureTime).getTime() : Number.MAX_SAFE_INTEGER);
  const pairReturnDepartureTs = (p: { outbound: any; returnFlight: any }) => (p.returnFlight?.departureTime ? new Date(p.returnFlight.departureTime).getTime() : Number.MAX_SAFE_INTEGER);
  const pairStableId = (p: { outbound: any; returnFlight: any }) => `${String(p.outbound?.id ?? "")}_${String(p.returnFlight?.id ?? "")}`;
  const stableOrder = (a: { outbound: any; returnFlight: any }, b: { outbound: any; returnFlight: any }) => {
    const outboundTsDiff = pairDepartureTs(a) - pairDepartureTs(b);
    if (outboundTsDiff !== 0) return outboundTsDiff;

    const returnTsDiff = pairReturnDepartureTs(a) - pairReturnDepartureTs(b);
    if (returnTsDiff !== 0) return returnTsDiff;

    return pairStableId(a).localeCompare(pairStableId(b));
  };
  ...
  if (sortBy === "cheapest") {
    return sorted.sort((a, b) => {
      ...
      const stopsDiff = pairStops(a) - pairStops(b);
  ...
  if (sortBy === "fastest") {
    return sorted.sort((a, b) => {
      ...
      return pairPayable(a) - pairPayable(b);
    });
  }
  ...
  const payables = sorted.map((p) => pairPayable(p));
  const durations = sorted.map((p) => pairDur(p)).filter((d) => d > 0);
...
const FlightResults = () => {
  ...
  // Round-trip pairing: N×N cross-product by airline (matching BDFare behavior).
  // Every unique outbound schedule × every unique return schedule for the same airline = all valid combos.
  const roundTripPairs = useMemo(() => {
    ...
    return pairs.sort((a, b) => pairPayable(a) - pairPayable(b));
  ...
  const filteredPairs = useMemo(() => {
    ...
    return sortRoundTripPairs(filtered, sortBy);
