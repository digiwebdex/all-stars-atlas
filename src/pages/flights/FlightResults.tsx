...
const AIRPORT_COORDS: Record<string, [number, number]> = {
  ...
  // Middle East
  DXB:[25.2528,55.3644],SHJ:[25.3286,55.5172],DOH:[25.2609,51.6138],AUH:[24.4331,54.6511],
  RUH:[24.9576,46.6988],JED:[21.6796,39.1565],MCT:[23.5933,58.2844],BAH:[26.2708,50.6336],
  KWI:[29.2266,47.9689],DMM:[26.4712,49.7979],MED:[24.5534,39.7051],
  // Southeast Asia
  SIN:[1.3502,103.9944],KUL:[2.7456,101.7072],BKK:[13.6811,100.7472],DMK:[13.9126,100.607],
  HKG:[22.3089,113.9145],MNL:[14.5086,121.0194],SGN:[10.8188,106.652],HAN:[21.2212,105.807],
  RGN:[16.9073,96.1332],CGK:[-6.1256,106.6558],PNH:[11.5466,104.8441],
  // East Asia
  NRT:[35.7647,140.3864],HND:[35.5494,139.7798],ICN:[37.4602,126.4407],
  PEK:[40.0799,116.6031],CAN:[23.3924,113.299],PVG:[31.1443,121.8083],TPE:[25.0777,121.2322],
  // Europe
  IST:[41.2753,28.7519],SAW:[40.8986,29.3092],LHR:[51.4706,-0.4619],LGW:[51.1481,-0.1903],
  CDG:[49.0097,2.5479],FRA:[50.0333,8.5706],AMS:[52.3086,4.7639],FCO:[41.8003,12.2389],
  MAD:[40.4719,-3.5626],BCN:[41.2971,2.0785],MUC:[48.3538,11.7861],ZRH:[47.4647,8.5492],
  MXP:[45.6306,8.7281],ATH:[37.9364,23.9445],VIE:[48.1103,16.5697],
  // Americas
  JFK:[40.6413,-73.7781],LAX:[33.9416,-118.4085],SFO:[37.6213,-122.379],ORD:[41.9742,-87.9073],
  MIA:[25.7959,-80.287],YYZ:[43.6777,-79.6248],GRU:[-23.4356,-46.4731],
  // South Asia / Oceania
  CMB:[7.1801,79.8841],KTM:[27.6966,85.3591],MLE:[4.1918,73.5291],KHI:[24.9065,67.1609],
  ISB:[33.6167,72.8],LHE:[31.5216,74.4036],SYD:[-33.9461,151.1772],MEL:[-37.6733,144.8433],
  // Africa
  CAI:[30.1219,31.4056],ADD:[8.9779,38.7993],NBO:[-1.3192,36.9278],JNB:[-26.1392,28.246],
};
